...
public class AdminService extends ClientService {
	...
	public int addCompany(Company company) throws CouponSystemException {
		if (companyRepo.existsByNameOrEmail(company.getName(), company.getEmail())) {
			throw new CouponSystemException("addCompany failed - already exist company with name: " + company.getName()
					+ " or by email: " + company.getEmail());
		} else {
	...
	public int addCustomer(Customer customer) throws CouponSystemException {
		if (customerRepo.existsByEmail(customer.getEmail())) {
			throw new CouponSystemException(
					"addCustomer failed - customer with Email " + customer.getEmail() + " already exist");
		} else {
	...
	public int updateCustomer(Customer customer) throws CouponSystemException {
		...
		if (opt.isPresent()) {
			...
			throw new CouponSystemException(
					"updateCustomer failed - customer with id " + customer.getId() + " not exist");
		}
	}
