...
public class CouponDBDAO implements CouponDAO {
	...
	@Override
	public List<Coupon> getCouponsWithCompanyIDAndCategory(int companyID, Category category)
		...
		try (PreparedStatement pstmt = con.prepareStatement(sql);) {
			...
			if (coupons.isEmpty()) {
				throw new CouponSystemException(
						"not exist any coupon from company " + companyID + " that the price less than " + maxPrice);
			}
			return coupons;
	...
	@Override
	public List<Coupon> getCustomerCouponByIDAndCategory(int customerID, Category category)
			throws CouponSystemException {
		Connection con = ConnectionPool.getInstance().getConnection();
		...
		try (PreparedStatement pstmt = con.prepareStatement(sql);) {
			...
			if (coupons.isEmpty()) {
				throw new CouponSystemException(
						"not exist any coupon from category: " + category + " customer " + customerID);
			}
			return coupons;
	...
	public List<Coupon> getCustomerCouponByIDAndmaxPrice(int customerID, float price) throws CouponSystemException {
		...
		try (PreparedStatement pstmt = con.prepareStatement(sql);) {
			...
			if (coupons.isEmpty()) {
				throw new CouponSystemException(
						"not exist any coupon under price: " + price + " customer " + customerID);
			}
			return coupons;
